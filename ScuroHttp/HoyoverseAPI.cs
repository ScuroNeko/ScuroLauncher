...
public static class HoyoverseApi
{
    public static async Task<string> GetLatestGenshinVersion()
    {
        var data = await Api.HoYoRequest<HoyoverseGameData>("https://hk4e-launcher-static.hoyoverse.com/hk4e_global/mdk/launcher/api/resource?launcher_id=10&key=gcStgarh&channel_id=1&sub_channel_id=3");
